...
describe('AccountSwitcher', () => {
    ...
    it('renders active account type and balance', () => {
        ...
        expect(screen.getByRole('img', { name: 'Real account' })).toHaveTextContent('🇺🇸');
    });

    it('shows the D badge for demo accounts in the account list', () => {
        render(<AccountSwitcher activeAccount={mockActiveAccount} />);
        fireEvent.click(screen.getByTestId('dt_acc_info'));
        expect(screen.getByRole('img', { name: 'Demo account' })).toHaveTextContent('D');
    });
