...
import { AdminPortal, AdminPortalProvider } from '@/components/admin-portal';
...
const AppContent = observer(() => {
    ...
    // Activate bot-builder tab when navigated via /bot-builder URL
    useEffect(() => {
        if (location.pathname === '/bot-builder') {
