...
export const recoverFromError = (promiseFn, recoverFn, errors_to_ignore, delay_index, api_base) => {
    return new Promise((resolve, reject) => {
        // Normalize synchronous request failures into the same promise path as
        // rejected API requests. Without this, a disconnected socket or a
        // synchronous validation error escapes doUntilDone entirely and the
        // interpreter never receives a purchase result.
